...
Cet espace en soit permet de regrouper les messages par **similarité 
Même si de nombreux groupes de messages ne concerne pas 
...
**Résilience temporelle** - L'avantage d'un tel algorithme est qu'il n'a pas de Rolex (oui il a raté sa vie), cela lui permet donc de faire des liens entre idées 
![screenshot](screenshots/temporel.png "")

**Thématique linguistique** - L'algorithme peut aussi descendre à un plus bas niveau
...
## Licence
Tous les scripts et codes de Democrite sont sous licence LGPL, et tous les outils utilisés sont également sous licence GPL, LGPL ou MIT.